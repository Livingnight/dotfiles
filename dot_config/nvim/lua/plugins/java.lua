return {
    ...
    config = function(_, opts)
      ...
      vim.api.nvim_create_autocmd("FileType", {
        ...
        callback = function(args)
          ...
          local ok, attached = pcall(attach_jdtls, args.buf)
  ...
  ---------------------------------------------------------------------------
  -- Treesitter: ensure Java parser
  ---------------------------------------------------------------------------
  {
    "nvim-treesitter/nvim-treesitter",
    opts = { ensure_installed = { "java", "scala", "kotlin" } },
  },

  ---------------------------------------------------------------------------
  -- nvim-dap: basic Java attach configuration
  ---------------------------------------------------------------------------
  -- {
